...
public class TabTweaksConfig {
    ...
    public static Screen configScreen(Screen parent) {
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder
                .title(Text.translatable("key.tab_tweaks.tab-tweaks"))
                .category(ConfigCategory.createBuilder()
                        .name(Text.translatable("key.tab_tweaks.tab-tweaks"))

                        // Visual

                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("key.tab_tweaks.visual"))
                                .option(Option.createBuilder(int.class)
                                        .name(Text.translatable("key.tab_tweaks.max-players"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.max-players.description")))
                                ...
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-header"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-header.description")))
                                        .binding(defaults.removeHeader, () -> config.removeHeader, newVal -> config.removeHeader = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-footer"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-footer.description")))
                                        .binding(defaults.removeFooter, () -> config.removeFooter, newVal -> config.removeFooter = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-header-shadow"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-header-shadow.description")))
                                        .binding(defaults.removeHeaderShadow, () -> config.removeHeaderShadow, newVal -> config.removeHeaderShadow = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-body-shadow"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-body-shadow.description")))
                                        .binding(defaults.removeBodyShadow, () -> config.removeBodyShadow, newVal -> config.removeBodyShadow = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-footer-shadow"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-footer-shadow.description")))
                                        .binding(defaults.removeFooterShadow, () -> config.removeFooterShadow, newVal -> config.removeFooterShadow = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-player-heads"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-player-heads.description")))
                                        .binding(defaults.removeHeads, () -> config.removeHeads, newVal -> config.removeHeads = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.improved-player-head-hats"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.improved-player-head-hats.description")))
                                        .binding(defaults.improvedHeads, () -> config.improvedHeads, newVal -> config.improvedHeads = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-ping"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-ping.description")))
                                        .binding(defaults.removePing, () -> config.removePing, newVal -> config.removePing = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.show-numerical-ping"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.show-numerical-ping.description")))
                                        .binding(defaults.showPingInTab, () -> config.showPingInTab, newVal -> config.showPingInTab = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.remove-numerical-ping-shadow"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.remove-numerical-ping-shadow.description")))
                                        .binding(defaults.removePingShadow, () -> config.removePingShadow, newVal -> config.removePingShadow = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.scale-numerical-ping"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.scale-numerical-ping.description")))
                                        .binding(defaults.scalePingDisplay, () -> config.scalePingDisplay, newVal -> config.scalePingDisplay = newVal)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.hide-fake-numerical-ping"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.hide-fake-numerical-ping.description")))
                        ...
                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("key.tab_tweaks.position"))
                                .option(Option.createBuilder(float.class)
                                        .name(Text.translatable("key.tab_tweaks.move-tab-list-down"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.move-tab-list-down.description")))
                                        ...
                                        .build())
                                .option(Option.createBuilder(boolean.class)
                                        .name(Text.translatable("key.tab_tweaks.move-tab-list-below-bossbars"))
                                        .description(OptionDescription.of(Text.translatable("key.tab_tweaks.move-tab-list-below-bossbars.description")))
                        ...
                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("key.tab_tweaks.tab-color"))
                                .option(Option.<Color>createBuilder()
                                        .name(Text.translatable("key.tab_tweaks.header-color"))
                        ...
                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("key.tab_tweaks.ping-color"))
                                .option(Option.<Color>createBuilder()
                                        .name(Text.translatable("key.tab_tweaks.ping-between-0-and-75"))
